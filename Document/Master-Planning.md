...
1. 土地利用原則
  ...
  |利用種別|原則|
  |:-|:-|
  |住宅区|路上駐車の多発による市内交通への影響を鑑み、新設する住宅についてはクルドサック(袋小路)型の住宅区形成を行うとともに、生活道路における自家用車と、搬出入車両・トラック等との分離を図ります。|
  |商業区|需要に応じて適宜設定するとともに、住宅区と汚染や騒音といった公害を発生させる区画・施設との緩衝エリアとして設定を行います。|
